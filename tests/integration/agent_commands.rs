...
pub fn test_agent_chat_commands() {
    ...
    let result = std::panic::catch_unwind(move || {
        ...
        // Test AgentInfo command
        {
            ...
            assert!(data["is_active"].as_bool().unwrap_or(false), "Agent should be active");
            assert!(data["conversation_stats"].is_object(), "Should have conversation stats");
        }
        ...
        // Test AgentHistory - retrieve conversation
        {
            ...
            assert_eq!(messages[1]["content"].as_str(), Some("Hello! I'm here to help with your knowledge graphs."));
